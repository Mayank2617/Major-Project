// Api Key : 541b877700b1415ba92102724230604
...
const GetWeather =  (city) =>{
    const url = `http://api.weatherapi.com/v1/forecast.json?key=541b877700b1415ba92102724230604&q=${city}&days=6&aqi=no&alerts=no`;
